  ...
  <div class="container">
    ...
    <form method="post">
      ...
      <div class="form-group">
        ...
        <input type="text" name="firstname" class="form-control" id="firstname" value="<?php echo $firstname ?>" placeholder="Enter your first name." maxlength="30" required="required">
      </div>
      <!-- nachname -->
      <div class="form-group">
        <label for="lastname">Surname *</label>
        <input type="text" name="lastname" class="form-control" id="lastname" value="<?php echo $lastname ?>" placeholder="Enter your surname." maxlength="30" required="required">
      </div>
      <!-- email -->
      <div class="form-group">
        <label for="email">Email *</label>
        <input type="email" name="email" class="form-control" id="email" value="<?php echo $email ?>" placeholder="Enter your email address." maxlength="100" required="required">
      </div>
      <!-- benutzername -->
      <div class="form-group">
        <label for="username">Username *</label>
        <input type="text" name="username" class="form-control" id="username" value="<?php echo $username ?>" placeholder="Upper and lower case letters, min 6 characters." pattern="(?=.*[a-z])(?=.*[A-Z])[a-zA-Z]{6,}" title="Upper and lower case letters, min 6 characters." maxlength="30" required="required">
      </div>
      <!-- password -->
      <div class="form-group">
